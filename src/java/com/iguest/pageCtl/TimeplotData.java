...
public class TimeplotData {
    ...
    static final Object[][] events = { //        {getDate(1849, 1, 1), "California Gold Rush"},
    ...
    static final Double[][] data = {
        {getDate(2017, 1, 1), 124d},
        {getDate(2017, 2, 1), 140d},
        {getDate(2017, 3, 1), 130d},
        {getDate(2017, 4, 1), 110d},
        {getDate(2017, 5, 1), 100d},
        {getDate(2017, 6, 1), 150d},
        {getDate(2017, 7, 1), 156d},
        {getDate(2017, 8, 1), 140d},
        {getDate(2017, 9, 1), 180d},
        {getDate(2017, 10, 1), 190d},
        {getDate(2017, 11, 1), 170d},
        {getDate(2017, 12, 1), 180d}
...
//        {getDate(2006, 1, 1), 1266264d}
    ...
    static final Double[][] dataIncome = {
        {getDate(2017, 1, 1), 45000000d},
        {getDate(2017, 2, 1), 54000000d},
        {getDate(2017, 3, 1), 66000000d},
        {getDate(2017, 4, 1), 55000000d},
        {getDate(2017, 5, 1), 74000000d},
        {getDate(2017, 6, 1), 42000000d},
        {getDate(2017, 7, 1), 71000000d},
        {getDate(2017, 8, 1), 76000000d},
        {getDate(2017, 9, 1), 82000000d},
        {getDate(2017, 10, 1), 73000000d},
        {getDate(2017, 11, 1), 67000000d},
        {getDate(2017, 12, 1), 89000000d}

    };

    static final Double[][] dataIncomeHarian = {
        {getDate(2017, 7, 1), 4500000d},
        {getDate(2017, 7, 2), 5400000d},
        {getDate(2017, 7, 3), 6600000d},
        {getDate(2017, 7, 4), 5500000d},
        {getDate(2017, 7, 5), 7400000d},
        {getDate(2017, 7, 6), 4200000d},
        {getDate(2017, 7, 7), 7100000d},
        {getDate(2017, 7, 8), 7600000d},
        {getDate(2017, 7, 9), 8200000d},
        {getDate(2017, 7, 10), 7300000d},
        {getDate(2017, 7, 11), 6700000d},
        {getDate(2017, 7, 12), 6900000d},
        {getDate(2017, 7, 13), 7900000d},
        {getDate(2017, 7, 14), 6900000d},
        {getDate(2017, 7, 15), 6400000d},
        {getDate(2017, 7, 16), 4600000d},
        {getDate(2017, 7, 17), 6700000d},
        {getDate(2017, 7, 18), 8000000d},
        {getDate(2017, 7, 19), 6500000d}
    ...
    static Double[][] getDataIncome() {
        return dataIncome;
    }

    static Double[][] getDataIncomeHarian() {
        return dataIncomeHarian;
    }
